...
### Problem 2
we import and clean data from `Trash-Wheel-Collection-Totals-7-2020-2.xlsx`： 
...
In the resulting dataset, there are 524 observations and 15 varibales, such as `r names(trash_wheel_tidy)`.
